 ...
 * Date: 01.02.2017
 * Time: 20:11
 * Это класс который я обычно использую для работы с базой данных, удобный, быстрый, безопасный
 *
...
class classes_sql {
     ...
     * @return classes_sql
     */
    static function a($array = array("pass" => "1111111111111", "db" => "teastauth")) {
        if (self::$openconn === null) {
            self::$openconn = new classes_sql($array);
        }
